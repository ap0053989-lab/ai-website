...
//       }}
//     >
//       {/* Custom Color Wheel Animation - SMALLER */}
//       <Box
//         sx={{
//           position: 'absolute',
//           top: '50%',
...
//               },
//             },
//             boxShadow: '0 0 30px rgba(207, 52, 118, 0.5)',
//           }}
//         />
...
//       {/* Main Content Container - Centered */}
//       <Container
//         maxWidth="md" // Changed from lg to md for more compact center
//         sx={{
//           position: 'relative',
//           zIndex: 2,
//           textAlign: 'center',
...
//                 background: 'linear-gradient(135deg, #d94b8a 0%, #fb9488 100%)',
//                 transform: 'translateY(-2px)',
//                 boxShadow: '0 8px 20px rgba(207, 52, 118, 0.5), 0 0 10px rgba(250, 128, 114, 0.3)',
//                 '&::before': {
//                   transform: 'translateX(100%)',
//                 },
//               },
...
//               opacity: 0.8,
//               position: 'relative',
//               padding: { xs: '0 25px', sm: '0 30px', md: '0 35px' },
//               textShadow: '0 1px 3px rgba(0, 0, 0, 0.5)',
//               mt: 1,
//               '&::before, &::after': {
//                 content: '""',
...
//           {/* Walmart Logo/Text - Added based on image */}
//           <Typography
//             component="div"
//             sx={{
//               color: '#FFFFFF',
...
//         minHeight: '100vh',
//         display: 'flex',
//         alignItems: 'center', // Changed from 'center' to 'flex-start' to push content down
//         justifyContent: 'center',
//         backgroundColor: 'transparent',
//         padding: { xs: '20px', sm: '30px', md: '40px' },
//         overflow: 'hidden',
//         pt: { xs: '10vh', sm: '20vh', md: '5vh' }, // Added top padding to push content down
//       }}
//     >
//       {/* Custom Color Wheel Animation - SMALLER and Moved Up */}
//       <Box
//         sx={{
//           position: 'absolute',
...
//       {/* Main Content Container - Positioned Lower */}
//       <Container
//         maxWidth="md"
//         sx={{
//           position: 'relative',
...
//           height: '100%',
//           minHeight: '100vh',
//           pt: { xs: '10vh', sm: '15vh', md: '20vh' }, // Added top padding
//         }}
//       >
//         <motion.div
//           initial={{ opacity: 0, y: 30 }}
...
//               lineHeight: { xs: 1.5, sm: 1.6, md: 1.7 },
//               fontWeight: 400,
//               maxWidth: { xs: '100%', sm: '85%', md: '550px' },
//               mx: 'auto',
//               opacity: 0.9,
//               textShadow: '0 1px 3px rgba(0, 0, 0, 0.5)',
//             }}
...
//               minWidth: { xs: '170px', sm: '190px', md: '210px' },
//               textTransform: 'uppercase',
//               letterSpacing: '0.3px',
//               border: 'none',
//               position: 'relative',
...
//               opacity: 0.8,
//               position: 'relative',
//               padding: { xs: '0 20px', sm: '0 25px', md: '0 30px' },
//               textShadow: '0 1px 3px rgba(0, 0, 0, 0.5)',
//               mt: 1,
//               '&::before, &::after': {
//                 content: '""',
...
//               textTransform: 'uppercase',
//               opacity: 0.7,
//               mt: { xs: 5, sm: 6, md: 7 }, // Increased margin top
//               textShadow: '0 1px 3px rgba(0, 0, 0, 0.5)',
//               borderTop: '1px solid rgba(255, 255, 255, 0.2)',
//               pt: 2,
//               width: '100%',
...
//   // Main text to type
//   const mainText = "GUARANTEED AI OUTCOMES.";
//   const subText = "Delivered by Our Team, or Yours";
//   const descriptionText = "Your most ambitious AI goals, executed with certainty. We offer flexible partnership models from turnkey projects to dedicated innovation hubs, designed to deliver the results you need.";
...
//           setDisplayedMainText(mainText.substring(0, mainIndex));
//           mainIndex++;
//           setTimeout(typeMain, 50); // Faster typing for main text
//         } else {
...
//           setDisplayedSubText(subText.substring(0, subIndex));
//           subIndex++;
//           setTimeout(typeSubText, 40); // Medium speed for subtext
//         } else {
//           // Start typing description after subtext is done
...
//           setDisplayedDescription(descriptionText.substring(0, descIndex));
//           descIndex++;
//           setTimeout(typeDescription, 20); // Faster for description
//         } else {
//           // Typing complete
//           setTimeout(() => {
//             setTypingComplete(true);
//             // Blink cursor for a while then hide
//             setTimeout(() => setShowCursor(false), 1000);
//           }, 500);
//         }
//       };

//       // Start the typing chain
//       setTimeout(typeMain, 500); // Initial delay
//     };
...
//                     marginLeft: '2px',
//                     backgroundColor: '#FFFFFF',
//                     animation: showCursor ? 'blink 0.7s infinite' : 'none',
...
//           {/* Divider Line - Animate in after typing */}
//           <motion.div
//             initial={{ width: 0, opacity: 0 }}
//             animate={typingComplete ? { width: { xs: '50px', sm: '70px', md: '90px' }, opacity: 0.5 } : {}}
...
//           {/* CTA Button - Animate in after typing */}
//           <motion.div
...
//           {/* Bottom Tagline - Animate in after typing */}
//           <motion.div
//             initial={{ opacity: 0 }}
//             animate={typingComplete ? { opacity: 1 } : {}}
...
//           {/* Walmart Logo/Text - Animate in after typing */}
//           <motion.div
//             initial={{ opacity: 0, y: 10 }}
//             animate={typingComplete ? { opacity: 0.7, y: 0 } : {}}
...
//       {/* Scroll Indicator - Animate in after typing */}
//       <motion.div
//         initial={{ opacity: 0 }}
//         animate={typingComplete ? { opacity: 0.7 } : {}}
...
//       {/* TIM Indicator - Animate in after typing */}
//       <motion.div
//         initial={{ opacity: 0 }}
//         animate={typingComplete ? { opacity: 0.7 } : {}}
...
const HeroSection = () => {
  ...
  // Text sequences for typing effect
  const textSequences = [
    "GUARANTEED",
    "AI",
    "OUTCOMES"
    ...
    const timer = setTimeout(() => {
      if (!isDeleting) {
        ...
        if (displayedText.length > 0) {
          ...
          setIsDeleting(false);
          setCurrentSequence((currentSequence + 1) % textSequences.length);
        }
      }
    }, speed);

    return () => clearTimeout(timer);
  }, [displayedText, isDeleting, currentSequence, inView]);
  ...
  const generateDNA = () => {
    ...
    for (let i = 0; i < nodes; i++) {
      const angle = (i * 180) / nodes;
      const x = Math.sin(angle) * 100;
      const y = i * 20 - 200;
      const z = Math.cos(angle) * 100;
      
      dna.push({ x, y, z, color: i % 2 === 0 ? primary : secondary });
    }
    
    return dna;
  };

  const dnaNodes = generateDNA();
    ...
    <Box ref={ref} sx={{
          ...
          return (
            <motion.div
              ...
              style={{
                ...
                background: `linear-gradient(to bottom, ${node.color}, ${nextNode.color})`,
                transformOrigin: 'top',
                transform: `
                  translate(-50%, -50%)
                  ...
                  rotateX(${Math.atan2(nextNode.y - node.y, Math.sqrt(Math.pow(nextNode.x - node.x, 2) + Math.pow(nextNode.z - node.z, 2)))}rad)
                  rotateZ(${Math.atan2(nextNode.x - node.x, nextNode.z - node.z)}rad)
                `,
              }}
            />
          );
        ...
        {[...Array(30)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              width: '2px',
              height: '100px',
              background: `linear-gradient(to top, transparent, ${i % 2 === 0 ? primary : secondary})`,
            }}
          />
        ))}
      </Box>
      ...
      {[...Array(8)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            width: `${50 + i * 20}px`,
            height: `${50 + i * 20}px`,
            border: `1px solid ${i % 2 === 0 ? primary : secondary}${20 + i * 5}`,
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        <Box sx={{ 
              ...
              >
                <Typography
                  ...
                  sx={{
                    ...
                    display: 'inline-block',
                    marginRight: '0.5rem',
                    textShadow: i === 1 ? `0 0 30px ${primary}` : 'none',
                    '&::after': i === 1 ? {
                      content: '""',
                      position: 'absolute',
                      bottom: '-10px',
                ...
                >
                  {currentSequence === i ? displayedText : word}
                </Typography>
              </motion.div>
            ))}
          </Box>
            ...
            <IconButton
              sx={{
                ...
                '&::before': {
                  ...
                  bottom: '-10px',
                  borderRadius: '50%',
                  background: `conic-gradient(from 180deg, ${secondary}, ${primary}, ${secondary})`,
          ...
          {[
            { text: 'VISION', position: 'top' },
            { text: 'TECH', position: 'right' },
            { text: 'IMPACT', position: 'bottom' },
            { text: 'GROWTH', position: 'left' },
          ].map((item, i) => (
            <motion.div
              key={item.text}
              initial={{ 
              ...
              animate={inView ? {
                ...
                y: item.position === 'top' ? -150 : item.position === 'bottom' ? 150 : 0,
              } : {}}
              transition={{
                delay: 1 + i * 0.2,
                type: "spring",
      ...
      {[...Array(3)].map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            right: 0,
            height: '2px',
            background: `linear-gradient(90deg, transparent, ${i % 2 === 0 ? primary : secondary}, transparent)`,
            boxShadow: `0 0 20px ${i % 2 === 0 ? primary : secondary}`,
            opacity: 0.3,
            zIndex: 0,
          }}
        />
